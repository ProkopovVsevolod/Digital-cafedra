...
(function (Transport) {
    ...
    var Vehicle = /** @class */ (function () {
        ...
        Vehicle.prototype.print = function () {
            var returnData = "VIN: ".concat(this.vin, " \u0412\u043B\u0430\u0434\u0435\u043B\u0435\u0446: ").concat(this.owner.name + " " + this.owner.sername, " \u041D\u043E\u043C\u0435\u0440: ").concat(this.regNum);
    ...
    var VehicleStorage = /** @class */ (function () {
        ...
        ;
        //Задание 1 
        VehicleStorage.prototype.getSortedByModel = function () {
            console.log("Хранилище до сортировки: ", this.getVehile());
            this.vehicleStorage.sort(function (a, b) {
            ...
            console.log("Хранилище после сортировки: ", this.getVehile());
        };
        VehicleStorage.prototype.getVehicleByModelEnd = function (endOfModel) {
            var result = this.vehicleStorage.filter(function (vehicle) {
                var modelLower = vehicle.model.toLowerCase();
                var endOfModelLower = endOfModel.toLowerCase();
                return modelLower.endsWith(endOfModelLower);
            });
            return result;
        };
